...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y7ihxvq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y7ihxvq.containers.anotherwebservice.com/
...
```
git clone git@github.com:AnkanRoy281/container-y7ihxvq.git
cd container-y7ihxvq
```
...
```
docker attach container-y7ihxvq
```
